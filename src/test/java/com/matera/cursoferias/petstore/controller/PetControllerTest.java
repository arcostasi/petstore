...
public class PetControllerTest {
    ...
    public void validaFindAll() throws Exception {
        ...
        mvc.perform(get("/api/v1/pets").contentType(APPLICATION_JSON))
           ...
           .andExpect(jsonPath("$[0].cliente.id", equalTo(pet1.getCliente().getId().intValue())))
           .andExpect(jsonPath("$[0].cliente.nome", equalTo(pet1.getCliente().getNome())))
           .andExpect(jsonPath("$[0].especie.id", equalTo(pet1.getEspecie().getId().intValue())))
           .andExpect(jsonPath("$[0].especie.descricao", equalTo(pet1.getEspecie().getDescricao())))
           ...
           .andExpect(jsonPath("$[1].cliente.id", equalTo(pet2.getCliente().getId().intValue())))
           .andExpect(jsonPath("$[1].cliente.nome", equalTo(pet2.getCliente().getNome())))
           .andExpect(jsonPath("$[1].especie.id", equalTo(pet2.getEspecie().getId().intValue())))
           .andExpect(jsonPath("$[1].especie.descricao", equalTo(pet2.getEspecie().getDescricao())));
    }
    ...
    public void validaFindById() throws Exception {
        ...
        mvc.perform(get("/api/v1/pets/" + pet1.getId()).contentType(APPLICATION_JSON))
           ...
           .andExpect(jsonPath("$.cliente.id", equalTo(pet1.getCliente().getId().intValue())))
           .andExpect(jsonPath("$.cliente.nome", equalTo(pet1.getCliente().getNome())))
           .andExpect(jsonPath("$.especie.id", equalTo(pet1.getEspecie().getId().intValue())))
           .andExpect(jsonPath("$.especie.descricao", equalTo(pet1.getEspecie().getDescricao())));
    }
