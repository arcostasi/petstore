...
public class ServicoControllerTest {
    ...
    public void validaSave() throws Exception {
    	...
    	petResponse.setCliente(cliente);
    	petResponse.setEspecie(especie);
    	...
    	servicoResponse.setPet(petResponse);
    ...
    public void validaFindAll() throws Exception {
        ...
        mvc.perform(get("/api/v1/servicos").contentType(APPLICATION_JSON))
           ...
           .andExpect(jsonPath("$[0].pet.id", equalTo(servico1.getPet().getId().intValue())))
           .andExpect(jsonPath("$[0].pet.nome", equalTo(servico1.getPet().getNome())))
           .andExpect(jsonPath("$[0].pet.dataNascimento", equalTo(servico1.getPet().getDataNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")))))
           .andExpect(jsonPath("$[0].pet.cliente.id", equalTo(servico1.getPet().getCliente().getId().intValue())))
           .andExpect(jsonPath("$[0].pet.cliente.nome", equalTo(servico1.getPet().getCliente().getNome())))
           .andExpect(jsonPath("$[0].pet.especie.id", equalTo(servico1.getPet().getEspecie().getId().intValue())))
           .andExpect(jsonPath("$[0].pet.especie.descricao", equalTo(servico1.getPet().getEspecie().getDescricao())))
           ...
           .andExpect(jsonPath("$[1].pet.id", equalTo(servico2.getPet().getId().intValue())))
           .andExpect(jsonPath("$[1].pet.nome", equalTo(servico2.getPet().getNome())))
           .andExpect(jsonPath("$[1].pet.dataNascimento", equalTo(servico2.getPet().getDataNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")))))
           .andExpect(jsonPath("$[1].pet.cliente.id", equalTo(servico2.getPet().getCliente().getId().intValue())))
           .andExpect(jsonPath("$[1].pet.cliente.nome", equalTo(servico2.getPet().getCliente().getNome())))
           .andExpect(jsonPath("$[1].pet.especie.id", equalTo(servico2.getPet().getEspecie().getId().intValue())))
           .andExpect(jsonPath("$[1].pet.especie.descricao", equalTo(servico2.getPet().getEspecie().getDescricao())));
    }
    ...
    public void validaFindById() throws Exception {
        ...
        mvc.perform(get("/api/v1/servicos/" + servico1.getId()).contentType(APPLICATION_JSON))
           ...
           .andExpect(jsonPath("$.pet.id", equalTo(servico1.getPet().getId().intValue())))
           .andExpect(jsonPath("$.pet.nome", equalTo(servico1.getPet().getNome())))
           .andExpect(jsonPath("$.pet.dataNascimento", equalTo(servico1.getPet().getDataNascimento().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")))))
           .andExpect(jsonPath("$.pet.cliente.id", equalTo(servico1.getPet().getCliente().getId().intValue())))
           .andExpect(jsonPath("$.pet.cliente.nome", equalTo(servico1.getPet().getCliente().getNome())))
           .andExpect(jsonPath("$.pet.especie.id", equalTo(servico1.getPet().getEspecie().getId().intValue())))
           .andExpect(jsonPath("$.pet.especie.descricao", equalTo(servico1.getPet().getEspecie().getDescricao())));
    }
